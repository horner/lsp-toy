...
> **💡 Web Client**: The WebSocket server also serves a Monaco editor-based web client:
> - **Info page**: `http://localhost:8080/` - Server information and setup instructions
> - **Web editor**: `http://localhost:8080/editor` - Full Monaco editor with LSP integration
> 
> This is useful for testing the LSP server in a browser environment without VS Code.
> 
